...
metadata {
    definition (name: "Hue Motion Temp Sensor", namespace: "jsdio", author: "JShen", vid: "generic-motion-4", ocfDeviceType: "x.com.st.d.sensor.motion") {
    ...
    preferences {        
		...
		section {
			input "tempOffset", "decimal", title: "Temperaturessss Offset", description: "Offset temperature by this many degrees", range: "*..*", displayDuringSetup: false
		}
